...
impl<R: RateController, T: TypeSelector, G: OrderGenerator, E: EventRouter, N: Rng> PoissonSource<R,T,G,E,N> {
	pub fn new(
		rate_controller: R,
		type_selector: T,
		order_generator: G,
...
impl<R: RateController, T: TypeSelector, G: OrderGenerator, E: EventRouter, N: Rng> EventSource for PoissonSource<R,T,G,E,N> {
	fn next_event(&mut self) {
