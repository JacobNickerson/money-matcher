...
class OrderBookModel(QAbstractTableModel):
    ...
    def __init__(self, asks=None, bids=None, spread=None, mid_price=None, max_levels=7):
        super().__init__()
    ...
    def row_data(self, row):
        if row < len(self.asks):
            ...
            return "mid", (self.mid_price_direction(), self.spread, 0)
        else:
